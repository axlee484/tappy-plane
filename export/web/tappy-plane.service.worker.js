...
/** @type {string} */
const CACHE_VERSION = '1766690967|2204237338';
/** @type {string} */
...
/** @type {string[]} */
const CACHED_FILES = ["tappy-plane.html","tappy-plane.js","tappy-plane.offline.html","tappy-plane.icon.png","tappy-plane.apple-touch-icon.png","tappy-plane.audio.worklet.js","tappy-plane.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["tappy-plane.wasm","tappy-plane.pck"];
